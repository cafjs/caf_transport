...
(function () {
    ...
    var APP_SEPARATOR = json_rpc.APP_SEPARATOR = '#';
     ...
     * @function
     */
    var patchMeta = json_rpc.patchMeta = function(msg, data) {
     ...
     * local name or four if fully qualified, i.e.,
     * appPublisher-appLocalName-caOwner-caLocalName.
     *
     ...
     *
     */
    var splitName = json_rpc.splitName = function(name, separator) {
     ...
     */
    var joinName = json_rpc.joinName = function() {
     ...
     * @return {string} A joined name with the standard separator.
     */
    var joinNameArray = json_rpc.joinNameArray = function(args, separator) {
        separator = separator || NAME_SEPARATOR;
